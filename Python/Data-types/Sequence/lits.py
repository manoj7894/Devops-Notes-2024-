...
# Final overview about list
marks = [10,45,35,]
print(marks)
print(type)
print(marks[1])         # Index Accesing
print(marks[0:3])        # Slicing accesing
marks.append(34)         # Single thing adding
print(marks)
marks.extend(["manoj", "ravi"])
print(marks)           # heterogeneous data
friends = ["vasmi", "varun", marks]    # nested list
print(marks)
print(type(marks))
del friends[0]           # Delelting
print(friends)
friends.remove("varun")
print(friends)
marks = [10, 39, 58, 67]
print(marks.pop(0))
print(marks)
